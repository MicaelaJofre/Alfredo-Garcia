 ...
 */
$config['successMessage'] = 'Your message was sent, Thank you!';
 ...
 * );
 */
$config['recipients'] = 'info@garciarevuelta.com';
 ...
 * $config['from'] = '%email%';
 */
$config['from'] = 'web@garciarevuelta.com';
 ...
 */
$config['subject'] = 'Web message from de %name%';
 ...
 */
$captcha = new Quform_Element('type_the_word', 'Escriba la palabra');
