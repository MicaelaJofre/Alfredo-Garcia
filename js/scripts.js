...
$(document).ready(function () {
  if (document.getElementsByClassName("cerdo")[0]) {
    var w = $(window).width();
    if (w < 720) $(".cerdo").css({ marginTop: "0" });
    window.onresize = function () {
      var w = $(window).width();
      if (w < 720) $(".cerdo").css({ marginTop: "0" });
      else $(".cerdo").css({ marginTop: "125px" });
    };
  }
  initOutdoor();
  initparallax();
  ...
  if (document.getElementById("menu-bio")) {
    ...
    if (w < 900) {
      ...
      setTimeout(function () {
        $("#menu-bio-ul").hide(800);
      }, 2000);
      $("#menu-bio").css({ left: "0px" });
      $("section").css({ padding: "20px" });
      $("#menu-bio-tog").show();
      $("#menu-bio-tog").click(function () {
        $("#menu-bio-ul").toggle();
      });
      // $("#menu-bio").show();
    } else {
